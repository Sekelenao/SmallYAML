...
/**
 * Implementation of {@link PropertyIdentifier} for a single optional property.
 *
 * @since 0.2.0
 */
public final class SingleOptionalIdentifier implements PropertyIdentifier {
    ...
    /**
     * Defines a new single optional identifier with the given key.
     *
     * @param key the property key
     * @return a new SingleOptionalIdentifier instance
